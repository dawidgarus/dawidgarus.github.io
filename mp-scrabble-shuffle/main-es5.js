...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _game_game_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./game/game.page */
    "./src/app/game/game.page.ts");
    /* harmony import */


    var _resolvers_seeds_resolver__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./resolvers/seeds-resolver */
    "./src/app/resolvers/seeds-resolver.ts");
    ...
    var routes = [{
      ...
      path: 'game/:seeds',
      component: _game_game_page__WEBPACK_IMPORTED_MODULE_4__["GamePage"],
      resolve: {
        seeds: _resolvers_seeds_resolver__WEBPACK_IMPORTED_MODULE_5__["SeedsResolver"]
      }
    }];
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _game_game_page__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./game/game.page */
    "./src/app/game/game.page.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _home_home_page__WEBPACK_IMPORTED_MODULE_9__["HomePage"], _game_game_page__WEBPACK_IMPORTED_MODULE_11__["GamePage"]],
      entryComponents: [],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_10__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot({
        animated: false,
        mode: 'ios'
  ...
  function srcAppGameGamePageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".container {\n  height: 100%;\n  overflow: auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppGameGamePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _utils_shuffle__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../utils/shuffle */
    ...
    var GamePage = /*#__PURE__*/function () {
      function GamePage(toast, route) {
        ...
        route.data.subscribe(function (data) {
          var shuffle = new _utils_shuffle__WEBPACK_IMPORTED_MODULE_3__["Shuffle"](TILES_EN, 10);
          ...
          _this2.queue = shuffle.getQueue();
          console.log('queue', _this2.queue.join(''));
          _this2.tiles = 1;
          _this2.count = 0;
          _this2.left = _this2.queue.length;
          _this2.history = [];
        });
      }
      ...
      _createClass(GamePage, [{
        ...
        value: function onDraw(tiles) {
          if (tiles <= this.left) {
            ...
            this.history = [{
              type: 'draw',
              count: tiles,
              tiles: this.queue.slice(count, count + tiles)
            }].concat(_toConsumableArray(this.history));
          }
        }
      }, {
        key: "onDiscard",
        value: function onDiscard(tiles) {
          if (tiles <= this.left) {
            var count = this.count;
            this.count += tiles;
            this.left -= tiles;
        ...
        value: function onUndo() {
          if (this.queue.length) {
            var _this$history = _toArray(this.history),
                last = _this$history[0],
                history = _this$history.slice(1);
    ...
    GamePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-game',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ToastController"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"]])], GamePage);
    /***/
  },
  ...
  function srcAppHomeHomePageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".container {\n  height: 100%;\n  overflow: auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var HomePage = /*#__PURE__*/function () {
      ...
      _createClass(HomePage, [{
        key: "trackByIndex",
        value: function trackByIndex(obj, index) {
          return index;
        }
      }, {
        key: "onRemoveSeed",
        value: function onRemoveSeed(index) {
          this.seeds = this.seeds.filter(function (seed, i) {
            return i !== index;
          });
        }
      }, {
        key: "onRandomizeSeed",
        value: function onRandomizeSeed(seed) {
          var value = "000000000".concat(Math.round(Math.random() * 10000000000));
          seed.value = value.substr(value.length - 10);
        }
      }, {
        key: "onAddSeed",
        value: function onAddSeed() {
          this.seeds = [].concat(_toConsumableArray(this.seeds), [{
            value: ''
          }]);
        }
      }, {
        ...
        value: function onPlay() {
          this.nav.navigateForward(['game', this.seeds.map(function (seed) {
            return seed.value;
          }).join(',')]);
        }
      }, {
  ...
  /*! exports provided: SeedsResolver */

  /***/
  function srcAppResolversSeedsResolverTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SeedsResolver", function () {
      return SeedsResolver;
    });
    /* harmony import */
    ...
    var SeedsResolver = /*#__PURE__*/function () {
      function SeedsResolver(route) {
        _classCallCheck(this, SeedsResolver);

        this.route = route;
      }

      _createClass(SeedsResolver, [{
        key: "resolve",
        value: function resolve(route, state) {
          var seeds = route.params.seeds.split(',');

          if (seeds.every(function (seed) {
            return seed.length === 10;
          })) {
            return seeds;
          } else {
    ...
    SeedsResolver.ctorParameters = function () {
      return [{
        type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]
      }];
    };

    SeedsResolver = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]])], SeedsResolver);
    /***/
  },
  ...
  /***/
  function srcAppUtilsShuffleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Shuffle = /*#__PURE__*/function () {
      function Shuffle(tilesString, size) {
        _classCallCheck(this, Shuffle);

        var tilesArray = tilesString.substr(0, size * size).split('');
        var tiles = Array(size).fill(null).map(function (row, i) {
          return Array(size).fill(null).map(function (col, j) {
            return tilesString.charAt(i * size + j) || null;
          });
        });
        this.tiles = tiles;
      }
      ...
      _createClass(Shuffle, [{
        key: "shuffle",
        value: function shuffle(seed, transpose) {
          ...
          var suffleBy = seed.split('').map(function (value) {
            return +value;
          });
          tiles = tiles.map(function (row, i) {
            return [].concat(_toConsumableArray(row.slice(row.length - suffleBy[i])), _toConsumableArray(row.slice(0, row.length - suffleBy[i])));
          });
        ...
        key: "shuffle2",
        value: function shuffle2(transpose) {
          this.shuffle23(2, transpose);
        }
      }, {
        key: "shuffle3",
        value: function shuffle3(transpose) {
          this.shuffle23(3, transpose);
        }
      }, {
        key: "getQueue",
        value: function getQueue() {
          return this.tiles.reduce(function (queue, row) {
            return [].concat(_toConsumableArray(queue), _toConsumableArray(row));
          }, []);
        }
      }, {
        key: "shuffle23",
        value: function shuffle23(step, transpose) {
          var tiles = this.tiles;
          ...
          tiles = [].concat(_toConsumableArray(tiles.filter(function (row, index) {
            return index % step === 1;
          }).reverse()), _toConsumableArray(tiles.filter(function (row, index) {
            return index % step !== 1;
          })));
        ...
        key: "transpose",
        value: function transpose(tiles) {
          return tiles[0].map(function (col, i) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! F:\Projects\mp-scrabble-shuffle\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
